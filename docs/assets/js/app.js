// Conceptual examples for Interactive Workbench; not serialized exports
const rules = [
  {
    screen: "home_screen",
...
const translations = {
  tr: {
    ...
    hero_desc: "Olay tabanlı Android yayınları ve yalnız etkin kurallar gerektiğinde çalışan dinleyicilerle; Shizuku IPC ve Kotlin Coroutines kullanan gizlilik odaklı otomasyon.",
    btn_download: "APK İndir (v1.1.0)",
    btn_copy: "KOPYALA",
    copied: "✓ KOPYALANDI",
    ...
    stat_telemetry_val: "0 telemetri <small>(Kullanıcının açıkça kullandığı ağ, SMS ve paylaşım özellikleri hariç)</small>",
    wb_label: "İnteraktif Kural Mühendisliği",
    wb_title: "Uygulamayı ve Otomasyon Mantığını İnceleyin",
    wb_desc: "Aşağıdaki hazır kuralları seçerek cihaz ekranını ve kavramsal otomasyon örneklerini inceleyin; gösterilen kod serileştirilmiş dışa aktarma biçimi değildir.",
    ...
    comp_row_1_new: "Olay tabanlı alıcılar ve ihtiyaç odaklı dinleyiciler",
    ...
    comp_row_4_new: "Sıfır telemetri ve hesap; dış iletişim yalnız açıkça kullanılan özelliklerle",
    ...
    mat_desc: "FlowPilot; NFC arka plan onayı, güvenli kural çoğaltma, çakışma uyarıları ve İngilizce/Türkçe uygulama diliyle Android'in yerel API sınırları içinde çalışır.",
    ...
    trig_nfc: "NFC Etiketi (arka planda onaylı)",
    ...
    act_hotspot: "Mobil Veri / Uçak Modu",
    ...
    inst_desc: "Root gerekmez. Shizuku, Android 11+ Kablosuz Hata Ayıklama veya USB üzerinden başlatılabilir.",
    step_1_badge: "ADIM 01",
    step_1_title: "APK'yı Yükleyin",
    step_1_desc: "GitHub Releases sayfasından derlenmiş FlowPilot-v1.1.0.apk dosyasını indirin veya ADB ile doğrudan cihaza kurun.",
  ...
  en: {
    ...
    hero_desc: "Privacy-focused automation using Shizuku IPC, Kotlin Coroutines, event-driven Android broadcasts, and listeners activated only when enabled rules need them.",
    btn_download: "Download APK (v1.1.0)",
    btn_copy: "COPY",
    copied: "✓ COPIED",
    ...
    stat_telemetry_val: "Zero telemetry <small>(excluding explicitly used network, SMS, and sharing features)</small>",
    wb_label: "Interactive Rule Engineering",
    wb_title: "Inspect the App & Automation Logic",
    wb_desc: "Select a preset to inspect its on-device screen and a conceptual automation example; shown code is not the serialized export format.",
    ...
    comp_row_1_new: "Event-driven receivers and demand-driven listeners",
    ...
    comp_row_4_new: "Zero telemetry and accounts; external communication only through explicitly used features",
    ...
    mat_desc: "FlowPilot works within Android's native API boundaries with background NFC confirmation, safe rule duplication, conflict warnings, and English/Turkish app language selection.",
    ...
    trig_nfc: "NFC Tag (background confirmation)",
    ...
    act_hotspot: "Mobile Data / Airplane Mode",
    ...
    inst_desc: "No root required. Shizuku can be started through Wireless Debugging on Android 11+ or over USB.",
    step_1_badge: "STEP 01",
    step_1_title: "Install the APK",
    step_1_desc: "Download FlowPilot-v1.1.0.apk from GitHub Releases or sideload it directly with adb install.",
...
function copyAdbInstall(el) {
  const cmd = "adb install FlowPilot-v1.1.0.apk";
